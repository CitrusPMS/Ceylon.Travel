...
const HeroBanner3 = () => {
    ...
    const heroContent = [
        {img:'https://ceylontravel.s3.us-east-1.amazonaws.com/03.png', subtitle:'Booking Now', title:' Lifelong Memories Just <br>A Few Days Away', content:'Making your dream to see the world come true is a thrilling and enriching goal. Traveling allows you to experience new cultures, cuisines, landscapes, and ways of life'},              
